...
namespace RpgMvc.Controllers
{
    public class DisputasController : Controller
    {
        ...
        public string uriBase = "http://KaueA.somee.com/RpgApi/Disputas/";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://KaueA.somee.com/RpgApi/PersonagemHabilidades/GetAllHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://KaueA.somee.com/RpgApi/Disputas/DisputaEmGrupo";
